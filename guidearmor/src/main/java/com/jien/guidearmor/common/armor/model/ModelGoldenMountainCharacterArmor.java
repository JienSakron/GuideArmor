...
public class ModelGoldenMountainCharacterArmor<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("modid", "mountain_character_armor"), "main");
	...
	public ModelGoldenMountainCharacterArmor(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		.texOffs(25, 22).addBox(-4.0F, 0.3F, -4.2F, 8.0F, 5.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));
